...
export const TablePage = () => {
    return (
        <section className="absolute gap-8 z-0 w-full h-full flex flex-col items-center justify-center">
            <Table className="w-[800px] relative border bg-card text-card-foreground shadow-sm">
                <TableHeader>
                    <TableRow>
                        <TableHead className="w-[120px]">Jméno hráče</TableHead>
                        <TableHead>Vytvořené kvízy</TableHead>
                        <TableHead>Vyplněné kvízy</TableHead>
                        <TableHead className="text-right">Správné odpovědi</TableHead>
                        <TableHead className="text-right">Špatné odpovědi</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
